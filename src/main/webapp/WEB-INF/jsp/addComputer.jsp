...
<mylib:errors successMessage="addcomputer.computer_added_successfully"
              errorMessage="addcomputer.could_not_add_computer"/>
            ...
            <div class="col-xs-8 col-xs-offset-2 box">
                ...
                <form id="computerForm" action="#" method="POST">
                    ...
                    <div class="actions pull-right">
                        <input id="submit" type="submit" value="<spring:message code="addcomputer.add"/>"
